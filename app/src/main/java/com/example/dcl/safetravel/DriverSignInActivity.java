    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(DriverSignInActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(DriverSignInActivity.this, "Registered", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                ...
                mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(DriverSignInActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(!task.isSuccessful()){
                            Toast.makeText(DriverSignInActivity.this, "Log IN Error", Toast.LENGTH_SHORT).show();
                        }else {
                          startActivity(new Intent(DriverSignInActivity.this,DriverMapActivity.class));
